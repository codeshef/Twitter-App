                ...
                if(e == null){
                    ...
                    if(objects.size()>0){
                        ...
                        for(ParseObject tweet: objects){
                            ...
                            simpleAdapter = new SimpleAdapter(Feed.this,tweetData,android.R.layout.simple_list_item_2,new String[] {"content","username"},new int[] {android.R.id.text1,android.R.id.text2});
